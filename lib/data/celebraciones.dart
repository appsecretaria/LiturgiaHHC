...
import '../models/apartado_informacion.dart';
...
const celebracionesVicencianas = <Celebracion>[
  Celebracion(
    ...
    descripcion: 'Mártires de la Revolución francesa, testigos fieles de Cristo y de la Iglesia.',
...
## ✝️ Pedro Renato Rogue

Nació en Vannes el 11 de junio de 1758. Se ordenó sacerdote el 12 de septiembre de 1782 y se dedicó tanto a la formación del clero como al ministerio parroquial, pese a las amenazas de la Revolución. Fue decapitado el 3 de marzo de 1796 y beatificado el 10 de mayo de 1934.
...
\n\nLa Iglesia nos los recuerda juntos para indicarnos que su fidelidad es única y la misma, dando testimonio apasionado hasta la muerte. Los Mártires del septiembre francés, vienen a decirnos y a repetirnos la historia del testimonio concentrado en una confesión sangrienta: no hay testimonio más verídico, que la historia martirial.''',
    ...
    lecturasEspirituales: [
      LecturaEspiritual(
        titulo: 'Buscad ante todo el Reino de Dios',

        encabezado: 'De las “Conferencias Espirituales” de San Vicente de Paúl',

        referencia: 'Conferencias a los misioneros, XI, 429-441',

        subtitulo: 'Buscad ante todo el Reino de Dios',

        contenido: '''Así pues, se dice que hay que buscar el Reino de Dios. Eso de buscarlo no es más que una palabra, pero me parece que dice muchas cosas; quiere decir que hemos de obrar de tal forma que aspiremos siempre a lo que nos recomienda, que trabajemos incesantemente por el Reino de Dios, sin quedarnos en una situación cómoda, y parados sin prestar atención a nuestro interior para arreglarlo bien, pero no a nuestro exterior para dedicarnos a él. Buscad, buscad, esto dice preocupación, esto dice acción. Buscad a Dios en vosotros, ya que San Agustín confiesa que, mientras lo andaba buscando fuera de él, no pudo encontrarlo; buscadlo en vuestra alma, como en su morada predilecta; es en el fondo donde sus servidores, que procuran practicar todas las virtudes, las establecen. Se necesita la vida interior, hay que procurarla; si falta, falta todo.

Procuremos, hermanos míos, hacernos interiores, hacer que Jesucristo reine en nosotros; busquemos, salgamos de ese estado de tibieza y de disipación, de esa situación secular y profana, que hace que nos ocupemos de los objetos que nos muestran los sentidos, sin pensar en el creador que los ha hecho, sin hacer oración para desprendernos de los bienes de la tierra.

Busquemos la gloria de Dios, busquemos el reino de Jesucristo. Mirad, se presenta la ocasión de que los enfermos le den a Dios parte de sus enfermedades; tienen que hacerlo. Hermanos míos, es propio del reino de Dios preferir el alma al cuerpo, el honor de Dios al del mundo. Bebamos el cáliz, abracemos la confusión, con la confianza de que todo vendrá en provecho nuestro. En fin, hay que decidirse, como el apóstol, a escoger los tormentos, y la misma muerte, antes que separarse de la caridad de Dios. Quizás se presente la ocasión de seguir a Jesucristo y sufrir la prisión, la tortura, el fuego, el martirio; ¡benditas ocasiones, que nos ofrecen el medio de hacer que reine, soberanamente el Hijo de Dios! Entreguémonos a él, hermanos míos, os lo pido por su santo nombre, para que nos conceda la gracia de preferir las penas y la muerte al peligro tremendo de perder su amor; tal debe ser nuestra decisión desde ahora. Sí, Dios mío, sí padres, si se presenta la ocasión de perder el honor, los placeres y la vida para que Jesucristo sea conocido y servido, viviendo y reinando por doquier, hemos de estar dispuestos por su misericordia.

Hagámosle, pues, de antemano este ofrecimiento, aunque la naturaleza sienta alguna repugnancia; tengamos la confianza de que Dios nos dará fortaleza cuando la necesitemos. «Os envío como corderos en medio de lobos», decía nuestro Señor a sus apóstoles. Él no quería que pensasen en la respuesta que habrían de dar a los príncipes y a los tiranos: «porque entonces, les decía, se os dirá lo que tenéis que decir». No dudéis, hermanos míos, de que así ocurrirá con vosotros en ocasiones semejantes, cuando tengáis que hablar y sufrir como perfectos cristianos. Dejémosle obrar a él y no pensemos más que en su amorosa y santa voluntad.''',
      ),

      LecturaEspiritual(
        titulo: 'Las cinco virtudes fundamentales de la Congregación',
        encabezado: 'De las "Conferencias Espirituales" de san Vicente de Paúl',
        referencia: 'Conferencias a los misioneros, XI, 583-592',
        subtitulo: 'Las cinco virtudes fundamentales de la Congregación',
        contenido: '''Aunque hemos de hacer todo lo posible por guardar todas estas máximas evangélicas, por ser tan santas y útiles, hay algunas de ellas que son para nosotros más apropiadas que las demos, o sea las que recomiendan especialmente la sencillez, la humildad, la mansedumbre, la mortificación y el celo de las almas; por eso, la congregación se aplicará a ellas de un modo más especial, de forma que esas cinco virtudes sean como las facultades del alma de toda la congregación y las acciones de cada uno de nosotros se vean siempre animadas por ellas.
...
¡Oh Salvador, Señor, Dios mío! Tú trajiste del cielo a la tierra esta doctrina, la recomendaste a los hombres y la enseñaste a los apóstoles, a quienes, entre los consejos que les diste, les dijiste que esta doctrina es como la base del cristianismo y que todo lo que no se cimiente en ella estará cimentado sobre arena; llénanos de este espíritu. Señor Dios mío, que has sellado con este espíritu a esta pequeña compañía, espíritu tan necesario para que responda a su vocación, tú eres su autor; me atrevo, Señor, a decir que sólo tú serás el culpable de que no lo tengamos, ya que todos nosotros ardemos en el deseo de poseerlo. Dispón nuestros corazones a recibir este espíritu. Tú eres, Señor, el que has suscitado esta compañía; tú eres su origen. Se nota, hermanos míos, algún progreso en la compañía; parece que reinan en ella estas cinco virtudes, si no en el grado en que las tuvieron nuestro Señor, los apóstoles y los primeros cristianos, al menos en estado incipiente, que seguirá adelante si procuramos conformar todas nuestras acciones a estas máximas evangélicas. Este es, padres, el fin por el que nos hemos hecho misioneros: ser sencillos, humildes, mansos, mortificados y celosos por la gloria de Dios. Es lo que hemos de pedirle y lo que hemos de esperar de su divina bondad; si lo creéis conveniente, hacemos mañana todos juntos la oración sobre este tema y espero que todos recibiremos en ello mucho consuelo. ¡Qué Dios nos conceda esta gracia!''',
  ...
  Celebracion(
    ...
    tipo: 'Solemnidad',
    imagen: 'assets/images/sv.jpg',

    rubrica: 'SAN VICENTE DE PAÚL, sacerdote',

    descripcion:
        'Fundador de la Congregación de la Misión y '
        'de la Compañía de las Hijas de la Caridad',

    primerasVisperas: true,
    laudes: true,
    eucaristia: true,
    segundasVisperas: true,
    lecturaEspiritual: true,
    ...
    informacion: [
      ApartadoInformacion(
        ...
        contenido:
            'Nace el 24 de abril de 1581 en Pouy, Aquitania. '
            'Recibe las órdenes sagradas el 23 de septiembre de 1600 '
            'en Château-l’Évêque. Comienza por ejercer el ministerio '
            'parroquial en París; luego asume una capellanía doméstica '
            'en la familia Gondi. Se entrega del todo al alivio de los '
            'pobres, instituye la Congregación de la Misión a este fin '
            'y, asimismo, para la formación del clero. Con la ayuda de '
            'Luisa de Marillac funda la Compañía de las Hijas de la '
            'Caridad. Muere en París el 27 de septiembre de 1660. '
            'Se le beatifica el 13 de agosto de 1729 y el 16 de junio '
            'de 1737 se le canoniza. León XIII le declara Patrón '
            'Universal de las obras caritativas.',
      ),
    ],

    lecturasEspirituales: [
      LecturaEspiritual(
        titulo: 'Evangelizar de palabra y obra',

        encabezado: 'De los escritos de San Vicente de Paúl',

        referencia:
            'Conferencia a los misioneros del 21 de febrero de 1659. '
            'XI/3, págs. 441-443',

        subtitulo: 'Dispuestos a la prisión y al martirio por su misericordia',

        contenido:
            'Dispuestos a la prisión y al martirio por su misericordia\n\n'
            'Hermanos míos, es propio del Reino de Dios preferir el alma '
            'al cuerpo, el honor de Dios al del mundo. Bebamos el cáliz, '
            'abracemos la confusión, con la confianza de que todo vendrá '
            'en provecho nuestro. En fin, hay que decidirse, como el Apóstol, '
            'a escoger los tormentos y la misma muerte antes que separarse '
            'de la caridad de Dios. Quizás se presente la ocasión de seguir '
            'a Jesucristo y sufrir la prisión, la tortura, el fuego, el '
            'martirio... ¡Benditas ocasiones, que nos ofrecen el medio de '
            'hacer que reine soberanamente el Hijo de Dios!\n\n'
            'Entreguémonos a Él, hermanos míos, os lo pido por su santo '
            'nombre, para que nos conceda la gracia de preferir las penas '
            'y la muerte al peligro tremendo de perder su amor. Tal debe '
            'ser nuestra decisión desde ahora. Sí, Dios mío, sí, padres; '
            'si se presenta la ocasión de perder el honor, los placeres y '
            'la vida, para que Jesucristo sea conocido y servido, viviendo '
            'y reinando por doquier, hemos de estar dispuestos, por su '
            'misericordia. Hagámosle, pues, de antemano este ofrecimiento, '
            'aunque la naturaleza sienta alguna repugnancia; tengamos la '
            'confianza de que Dios nos dará fortaleza cuando la necesitemos. '
            '«Os envío como corderos en medio de lobos», decía nuestro Señor '
            'a sus apóstoles. Él no quería que pensasen en la respuesta que '
            'habrían de dar a los príncipes y a los tiranos, porque entonces '
            '—les decía— se os dirá lo que tenéis que decir. No dudéis, '
            'hermanos míos, de que así ocurrirá con vosotros en ocasiones '
            'semejantes, cuando tengáis que hablar y sufrir como perfectos '
            'cristianos.\n\n'
            'Dejémosle obrar a Él y no pensemos más que en su amorosa y '
            'santa voluntad. ¡Quién nos diera el celo de santa Teresa, que '
            'hizo voto de escoger siempre la gloria de su Señor, y no sólo '
            'su gloria, sino su mayor gloria! Se presentaba la ocasión de '
            'hacer una obra buena en su honor; pero si luego aparecía otra '
            'de mayor importancia, acudía a ésta y dejaba para después la '
            'otra. Se comprometió de palabra y en conciencia a obrar siempre '
            'de este modo. Esa era también la norma de san Ignacio: '
            'Ad majorem Dei gloriam.\n\n'
            'Si hay alguno entre nosotros que sienta este mismo deseo, '
            'enhorabuena, hermanos míos; abrid vuestros corazones a esta '
            'divina inspiración y seguid este noble movimiento, que siempre '
            'os llevará hacia arriba. Y los demás, que se arrastran por '
            'debajo —como yo, miserable de mí—, que se levanten. Entreguémonos '
            'a Dios para desear y procurar que se extienda en nosotros el '
            'Reino de Dios; que se extienda sobre el estado eclesiástico y '
            'sobre todos los pueblos. Al obrar de esta forma, practicaremos '
            'lo que nuestro Señor y nuestro celo piden de nosotros por este '
            'artículo.\n\n'
            '¡Salvador mío, Jesucristo!, que te santificaste para que fueran '
            'santificados los hombres; que huiste de los reinos de la tierra, '
            'de sus riquezas y de su gloria, y sólo pensaste en el reino de '
            'tu Padre en las almas: Non quaero gloriam meam... sed honorifico '
            'Patrem meum. Si tú viviste así para con tu Padre —ya que eres '
            'Dios en relación con Él—, ¿qué deberemos hacer nosotros para '
            'imitarte a ti, que nos sacaste del polvo y nos llamaste a '
            'observar tus consejos y aspirar a la perfección? ¡Ay, Señor! '
            'Atráenos a ti; danos la gracia de entrar en la práctica de tu '
            'ejemplo y de nuestra regla, que nos lleva a buscar el Reino de '
            'Dios y su justicia, y a abandonarnos a Él en todo lo demás. Haz '
            'que tu Padre reine en nosotros, y reina tú mismo, haciendo que '
            'nosotros reinemos en ti por la fe, por la esperanza y por el '
            'amor; por la humildad, por la obediencia y por la unión con tu '
            'divina majestad.\n\n'
            'Al hacer así, tenemos motivos para esperar que algún día '
            'reinaremos en tu gloria, que nos has merecido con tu preciosa '
            'sangre. Esto, hermanos míos, es lo que hemos de pedirle en la '
            'oración; y durante todo el día, desde que despertemos, diga cada '
            'uno en su interior: «¿Qué haré para que Dios reine como soberano '
            'en mi corazón? ¿Qué haré para extender por todo el mundo el '
            'conocimiento y el amor de Jesucristo? ¡Mi buen Jesús, enséñame '
            'a hacerlo y haz que así lo haga!». Cuando suene el reloj, '
            'renovemos esta oración y la resolución de trabajar en ello; y, '
            'sobre todo, en la santa misa, establecida para reconocer de '
            'forma soberana la suprema majestad de Dios y alcanzar las '
            'gracias necesarias para vivir y morir bajo el reino glorioso '
            'de su Hijo eterno.',
      ),

      LecturaEspiritual(
        titulo: 'El servicio a los pobres ha de ser preferido a todo',

        encabezado: 'De las "Conferencias Espirituales" de san Vicente de Paúl',

        referencia:
            'Conferencias a los misioneros y a las Hermanas, XI, 725; '
            'X, 954-955; IX, 297-298, 1125; XI, 273',

        subtitulo: 'El servicio a los pobres ha de ser preferido a todo',

        contenido:
            'El servicio a los pobres ha de ser preferido a todo\n\n'
            'No hemos de considerar a un pobre campesino o a una pobre mujer '
            'según su aspecto exterior, ni según la impresión de su espíritu, '
            'dado que con frecuencia no tienen ni la figura ni el espíritu de '
            'las personas educadas, pues son vulgares y groseros. Pero dadle '
            'la vuelta a la medalla y veréis con las luces de la fe que son '
            'ésos los que nos representan al Hijo de Dios, que quiso ser pobre; '
            'él casi ni tenía aspecto de hombre en su pasión y pasó por loco '
            'entre los gentiles y por piedra de escándalo entre los judíos; '
            'y por eso mismo pudo definirse como el evangelista de los pobres: '
            '“Me ha enviado a evangelizar a los pobres”.\n\n'
            'Porque es para él un honor entrar en sus sentimientos, seguirlos, '
            'hacer lo que él hizo y realizar lo que él ha ordenado. Pues bien, '
            'sus sentimientos más íntimos han sido preocuparse de los pobres '
            'para curarlos, consolarlos, socorrerlos y recomendarlos; en ellos '
            'es en quienes ponía todo su afecto. Y él mismo quiso nacer pobre, '
            'recibir en su compañía a los pobres, servir a los el mal que les '
            'hacemos a los pobres los considerará como hechos a su divina '
            'persona. ¿Podía acaso demostrarles un amor más tierno a los pobres? '
            '¿Y qué amor podemos nosotros tenerle a él si no amamos lo que él '
            'amó? No hay ninguna diferencia entre amarle a él y amar a los '
            'pobres de ese modo; servir bien a los pobres es servirle a él; '
            'es honrarle como es debido e imitarle en nuestra conducta. Si esto '
            'es así, ¡cuántos motivos tenemos para animarnos a proseguir estas '
            'buenas obras, diciendo ya desde ahora desde lo más profundo de '
            'nuestros corazones: «Sí, me entrego a Dios para cuidar de los '
            'pobres y para practicar con ellos las obras de caridad; les '
            'atenderé, les querré, les cuidaré; y, a ejemplo de Nuestro Señor, '
            'amaré a quienes les consuela y respetaré a todos los que les '
            'visiten y atiendan»! Pues bien, si nuestro bondadosísimo Salvador '
            'se considera honrado con esta imitación, ¡cómo hemos de sentirnos '
            'también nosotros honrados en poder hacernos semejantes a él! '
            '¿No os parece, señoras, que es éste un motivo muy poderoso para '
            'renovar en ustedes el primer fervor? En cuanto a mí, creo que '
            'debemos ofrecernos hoy a su divina Majestad, para que nos anime '
            'de su misma caridad, de forma que en adelante se pueda decir de '
            'todas ustedes que es la caridad de Cristo la que les impulsa.\n\n'
            'Os diré que no se admite retraso alguno cuando se trata del '
            'servicio a los pobres. Sí, a la hora de vuestra oración, por la '
            'mañana, tenéis que ir a llevar una medicina, marchad tranquilamente; '
            'después de un acto de resignación con la santa voluntad de Dios, '
            'ofrecedle vuestra acción, unid vuestra intención a la oración que '
            'se tiene en la casa, o en otras partes, y marchaos sin ninguna '
            'preocupación.\n\n'
            'Sí, cuando estáis de vuelta, vuestra comunidad os permite hacer '
            'un poco de oración o de lectura espiritual, ¡estupendamente! Pero '
            'no tenéis que inquietaros por ello, ni creer que habéis faltado, '
            'cuando la perdáis; porque no se la pierde cuando se la deja por '
            'un motivo legítimo. Y si hay algún motivo legítimo, mis queridas '
            'hijas, es el servicio del prójimo. El dejar a Dios por Dios no es '
            'dejar a Dios, esto es, dejar una obra de Dios para hacer otra, '
            'o de más obligación o de mayor mérito.\n\n'
            'Dejáis la oración o la lectura, o perdéis el silencio por asistir '
            'a un pobre: pues sabed, hijas mías, que hacer esto, es servir a '
            'Dios. ¡Qué consuelo para una buena Hija de la Caridad pensar: '
            '«Voy a asistir a mis pobres enfermos, pero Dios se complacerá más '
            'en esto que en la oración que tenía que hacer ahora»! Y marchar '
            'alegremente a donde Dios la llama.\n\n'
            'Porque, mirad, la caridad está por encima de todas las reglas y '
            'es preciso que todas lo tengáis en cuenta. La caridad es una gran '
            'dama; hay que hacer todo lo que ordena. Por tanto, en ese caso, '
            'dejar a Dios por Dios. Dios os llama a hacer oración y al mismo '
            'tiempo os llama a atender a aquel pobre enfermo. Eso se llama '
            'dejar a Dios por Dios.\n\n'
            'Dios ama a los pobres, y por consiguiente ama a quienes aman a '
            'los pobres; pues, cuando se ama mucho a una persona, se siente '
            'también afecto a sus amigos y servidores. Pues bien, esta pequeña '
            'compañía de la Misión procura dedicarse con afecto a servir a los '
            'pobres, que son los preferidos de Dios; por eso tenemos motivos '
            'para esperar que, por amor hacia ellos, también nos amará Dios '
            'a nosotros. Así pues, hermanos míos, vayamos y ocupémonos con un '
            'amor nuevo en el servicio de los pobres, y busquemos incluso a '
